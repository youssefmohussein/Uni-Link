...
class AuthService {
    ...
    public function login(string $identifier, string $password): User {
        try {
            // Log login attempt
            error_log("AuthService: Login attempt for identifier: '{$identifier}'");
            ...
            // Log the exception
            error_log("AuthService: Login exception - " . $e->getMessage() . " (Code: " . $e->getCode() . ")");
            
            // Re-throw with original code
            throw $e;
        }
    }
