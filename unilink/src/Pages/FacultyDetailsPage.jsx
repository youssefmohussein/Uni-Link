...
const FacultyDetailsPage = () => {
    ...
    useEffect(() => {
        const fetchFaculty = async () => {
            try {
                setLoading(true);
                const rawData = await getFacultyById(id);
    ...
    return (
        <div className="relative w-full min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-hidden pt-24 px-6 md:px-20">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#008080]/10 rounded-full blur-[100px] animate-pulse"></div>
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                <Link to="/faculties" className="inline-flex items-center text-[#008080] mb-8 hover:text-[#00a0a0] transition-colors gap-2 group">
                ...
                <GlassCard className="p-12 w-full animate-fade-in-up shadow-2xl border border-white/10 hover:border-white/20 transition-all duration-500">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 pb-8 border-b border-white/10">
                        <div>
                            <h1 className="text-6xl md:text-7xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-white via-[#008080] to-white/70 mb-4 leading-tight">
                                {faculty.name || faculty.faculty_name}
                            </h1>
                            <div className="flex items-center gap-3">
                                <span className="bg-gradient-to-r from-[#008080] to-[#00a0a0] px-5 py-2 rounded-full text-sm font-semibold shadow-lg shadow-[#008080]/30">
                                    Faculty
                                </span>
                    ...
                    {faculty.major_names && (
                        <div className="mb-12 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                            <h3 className="text-3xl font-bold mb-6 flex items-center gap-3">
                                <span className="w-12 h-1.5 bg-gradient-to-r from-[#008080] to-transparent rounded-full"></span>
                            ...
                            <div className="flex flex-wrap gap-4">
                                {faculty.major_names && String(faculty.major_names || '').split(',').map(m => m.trim()).filter(m => m).map((major, i) => (
                                    <div
                                        key={i}
                                        className="bg-gradient-to-br from-white/10 to-white/5 border border-white/20 px-6 py-3 rounded-2xl hover:bg-gradient-to-br hover:from-[#008080]/20 hover:to-[#008080]/10 hover:border-[#008080]/50 hover:shadow-lg hover:shadow-[#008080]/20 transition-all duration-300 cursor-default group flex items-center gap-3"
                                    >
                                        <div className="w-2.5 h-2.5 rounded-full bg-[#008080]/60 group-hover:bg-[#008080] group-hover:shadow-lg group-hover:shadow-[#008080]/50 transition-all"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10 border-t border-white/10">
                        ...
                        <div className="group relative bg-gradient-to-br from-[#008080]/10 to-transparent border border-[#008080]/30 p-8 rounded-3xl text-center hover:from-[#008080]/20 hover:border-[#008080]/50 hover:shadow-2xl hover:shadow-[#008080]/20 transition-all duration-500 cursor-default transform hover:-translate-y-1">
                            <div className="text-5xl font-extrabold text-[#008080] mb-3 group-hover:scale-110 transition-transform duration-300">
                            ...
                            {faculty.major_names && (
                                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-6 w-72 p-6 bg-gradient-to-br from-gray-900 to-black border-2 border-[#008080]/40 rounded-3xl backdrop-blur-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-500 z-[100] shadow-[0_25px_60px_rgba(0,128,128,0.4)] pointer-events-none">
                                    <h4 className="text-[#008080] font-bold mb-4 text-base uppercase tracking-widest flex items-center gap-2">
                                    ...
                                    <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-6 h-6 bg-gradient-to-br from-gray-900 to-black border-r-2 border-b-2 border-[#008080]/40 rotate-45"></div>
                                </div>
                            )}
                        </div>
