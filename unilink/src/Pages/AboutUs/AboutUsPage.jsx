            ...
            <main className="relative z-10 pt-32 px-6 md:px-20 max-w-7xl mx-auto flex flex-col gap-24 pb-32">
                ...
                <section className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:flex-1 h-[400px] lg:h-[600px] relative z-0 flex items-center justify-center -mt-20 mb-24 lg:self-start lg:mt-0 lg:mb-0 lg:-mt-96 lg:-translate-y-[148px]">
                        ...
                        >
                            {/* Card 1: The Spark */}
                            <Card className="bg-[rgba(0,0,0,0.8)] border border-white/10 p-8 flex flex-col justify-center items-start text-left shadow-2xl">
                ...
                <section className="text-center relative z-30">
                    ...
                    <button className="bg-accent hover:bg-accent-hover text-white font-bold py-4 px-12 rounded-full text-lg transition-colors">
